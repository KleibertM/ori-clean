export default function Footer() {
  return (
    <footer className="pt-16 pb-8 px-6" id="nosotros">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h4 className="font-black text-slate-900 mb-4 uppercase tracking-tighter">LimpiaTodo</h4>
        ...
        <div className="pt-8 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-400">© {new Date().getFullYear()} LimpiaTodo. Los precios se confirman vía WhatsApp.</p>
        </div>
      </div>
    </footer>
  );
